  ...
  if (canvasEl) {
    var ctx = canvasEl.getContext('2d', { willReadFrequently: true }),
      ...
      setCanvasSize = debounce(function () {
        (canvasEl.width = 2 * window.innerWidth), (canvasEl.height = 2 * window.innerHeight), (canvasEl.style.width = window.innerWidth + 'px'), (canvasEl.style.height = window.innerHeight + 'px'), canvasEl.getContext('2d', { willReadFrequently: true }).scale(2, 2);
      }, 500),
      render = anime({
        duration: 1 / 0,
        update: function () {
