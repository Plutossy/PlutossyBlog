 ...
 * @LastEditTime: 2024-05-08 09:14:01
...
<template>
  <div class="song-list">
    ...
    <el-row v-for="site in songList" :key="site.id" class="song-list-content" :style="{ color: site.id == songContent.id && playStatus === true ? 'blue' : '#000000' }" @click="cutSong(site)">
    ...
    <el-row justify="center">
      <el-pagination :page-size="5" :pager-count="5" layout="prev, pager, next" :total="28" :hide-on-single-page="true" background class="animate__animated animate__fadeInUpBig" />
    </el-row>
  </div>
</template>
...
import { getSongList } from '@/api/modules/song.js';
